...
import { AppProvider, Page, Card, FormLayout, Text, TextField, Button, Layout, DataTable, BlockStack, RadioButton, Spinner } from "@shopify/polaris";
...
const loader$6 = async ({ request }) => {
  ...
  return json(
    settings.length > 0 ? { success: true, settings } : { success: false, message: "No settings found" },
    {
      status: 200,
...
function App() {
  ...
  return /* @__PURE__ */ jsxs(AppProvider$1, { isEmbeddedApp: true, apiKey, children: [
    /* @__PURE__ */ jsxs(NavMenu, { children: [
      ...
      /* @__PURE__ */ jsx(Link, { to: "/app/additional", children: "Table" })
    ] }),
    /* @__PURE__ */ jsx(Outlet, {})
  ] });
}
...
const loader$1 = async ({ request }) => {
  ...
  const settings = await prisma$1.setting.findMany({
    where: {
      sessionId: session.session_id
    },
    include: {
...
function AdditionalPage() {
  ...
  useEffect(() => {
    ...
    if ((_b = fetcher.data) == null ? void 0 : _b.data) {
      setSettings(fetcher.data.data);
    }
  }, [fetcher.data]);
  const rows = settings.map((setting) => {
    ...
    return [
      setting.id,
      setting.text,
      ((_a2 = setting.pageOption) == null ? void 0 : _a2.title) || "N/A",
      /* @__PURE__ */ jsx(Button, { destructive: true, onClick: () => handleDelete(setting.id), children: "Delete" })
    ];
  });
  return /* @__PURE__ */ jsxs(Page, { children: [
    /* @__PURE__ */ jsx(TitleBar, { title: "Settings Table" }),
    /* @__PURE__ */ jsx(Layout, { children: /* @__PURE__ */ jsx(Layout.Section, { children: /* @__PURE__ */ jsx(Card, { title: "All Settings", children: /* @__PURE__ */ jsx(
      DataTable,
      {
...
const loader = async ({ request }) => {
  await authenticate.admin(request);
  const pageOptions = await prisma$1.pageOption.findMany({});
...
const action = async ({ request }) => {
  ...
  const count = await prisma$1.setting.count({
    where: {
      sessionId: session.session_id
    }
  });
...
function Index() {
  ...
  return /* @__PURE__ */ jsxs(Page, { children: [
    /* @__PURE__ */ jsx(TitleBar, { title: "Shopify Remix Boiler Plate" }),
    /* @__PURE__ */ jsx(BlockStack, { gap: "500", children: /* @__PURE__ */ jsx(Layout, { children: /* @__PURE__ */ jsx(Layout.Section, { children: /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsx("p", { children: "Welcome to the Shopify Remix Boiler Plate" }),
      /* @__PURE__ */ jsx(fetcher.Form, { method: "post", children: /* @__PURE__ */ jsxs(FormLayout, { children: [
        /* @__PURE__ */ jsx(
          TextField,
          {
            name: "bannerText",
        ...
        /* @__PURE__ */ jsx("div", { children: pageOptions.map((option) => /* @__PURE__ */ jsx(
          RadioButton,
          {
            label: option.title,
        ...
        /* @__PURE__ */ jsx("input", { type: "hidden", name: "pageOption", value: pageOption }),
        /* @__PURE__ */ jsx(Button, { submit: true, primary: true, disabled: isLoading, children: isLoading ? /* @__PURE__ */ jsx(Spinner, { size: "small" }) : "Save" })
      ] }) })
    ] }) }) }) })
  ] });
}
...
const serverManifest = { "entry": { "module": "/assets/entry.client-Bic-Msdu.js", "imports": ["/assets/components-DT2JeTQS.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/root-BPWBDONu.js", "imports": ["/assets/components-DT2JeTQS.js"], "css": [] }, "routes/webhooks.app.scopes_update": { "id": "routes/webhooks.app.scopes_update", "parentId": "root", "path": "webhooks/app/scopes_update", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/webhooks.app.scopes_update-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/webhooks.app.uninstalled": { "id": "routes/webhooks.app.uninstalled", "parentId": "root", "path": "webhooks/app/uninstalled", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/webhooks.app.uninstalled-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/api.app.extension": { "id": "routes/api.app.extension", "parentId": "root", "path": "api/app/extension", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api.app.extension-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/auth.login": { "id": "routes/auth.login", "parentId": "root", "path": "auth/login", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BvmRZ8Ld.js", "imports": ["/assets/components-DT2JeTQS.js", "/assets/styles-Dp6PhViG.js", "/assets/Page-Dt8LTF1f.js", "/assets/FormLayout-CD28zoJp.js", "/assets/context-C_RzwAk6.js"], "css": [] }, "routes/auth.$": { "id": "routes/auth.$", "parentId": "root", "path": "auth/*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/auth._-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/_index": { "id": "routes/_index", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DuJs1Fit.js", "imports": ["/assets/components-DT2JeTQS.js"], "css": ["/assets/route-Cnm7FvdT.css"] }, "routes/app": { "id": "routes/app", "parentId": "root", "path": "app", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/app-w458NigW.js", "imports": ["/assets/components-DT2JeTQS.js", "/assets/styles-Dp6PhViG.js", "/assets/index-2ay1C4AH.js", "/assets/context-C_RzwAk6.js"], "css": [] }, "routes/app.additional": { "id": "routes/app.additional", "parentId": "routes/app", "path": "additional", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app.additional-C_P3cM_a.js", "imports": ["/assets/components-DT2JeTQS.js", "/assets/index-2ay1C4AH.js", "/assets/Page-Dt8LTF1f.js", "/assets/Layout-CmodH1us.js", "/assets/context-C_RzwAk6.js"], "css": [] }, "routes/app._index": { "id": "routes/app._index", "parentId": "routes/app", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": true, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/app._index-ClVl2jSE.js", "imports": ["/assets/components-DT2JeTQS.js", "/assets/index-2ay1C4AH.js", "/assets/Page-Dt8LTF1f.js", "/assets/Layout-CmodH1us.js", "/assets/FormLayout-CD28zoJp.js", "/assets/context-C_RzwAk6.js"], "css": [] } }, "url": "/assets/manifest-30465229.js", "version": "30465229" };
...
const routes = {
  ...
  "routes/api.app.extension": {
    id: "routes/api.app.extension",
    parentId: "root",
    path: "api/app/extension",
    index: void 0,
    caseSensitive: void 0,
    module: route3
  },
